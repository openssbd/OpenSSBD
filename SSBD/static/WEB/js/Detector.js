...
//		element.style.margin = '5em auto 0';
		...
		if ( ! this.webgl ) {
			...
			element.innerHTML = window.WebGLRenderingContext ? [
				...
				'Please find out how to get it <a href="http://get.webgl.org/" style="color:#fff">here</a>.'
			].join( '\n' ) : [
